...
## 📌 Checklist per Prossimi Job

- [ ] Verificare che `spark.executor.cores=3` sia applicato
- [ ] Controllare Spark UI per tipo di join usato (Broadcast vs SortMerge)
- [ ] Monitorare durata stage di shuffle con Dynamic Allocation
- [ ] Validare che shuffle partitions siano coalesce correttamente (vedi AQE stats)
- [ ] Verificare preemption events nei log YARN
